...
if(beforeTranslate.length === afterTranslate.length){
    ...
    fs.writeFileSync(path.join(__dirname, 'json/subjectKeywords.json'), JSON.stringify(countData, false), 'utf-8');
    ...
    console.log('Data Length Does Not Match!');
}